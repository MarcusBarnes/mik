...
class TemplatedMetadataParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateMetadata()
    {
        $settings = array(
            ...
            'METADATA_PARSER' => array(
                'template' => dirname(__FILE__) . '/assets/templated_metadata_parser/templated_mods_twig.xml',
            ),
        );

        $parser = new \mik\metadataparsers\templated\Templated($settings);
