...
class SimpleArchive extends Writer
{
    /**
    ...
    public function writePackages($metadata, $pages, $record_id)
    {
        ...
        // Whether to use record filename from identifier vs. record_id
    ...
    // that fact and skip writing the package.
        ...
        $XML_expected = in_array('XML', $this->datastreams);
        if ($XML_expected xor $no_datastreams_setting_flag) {
            $metadata_file_path = $output_path . $identifier . '.xml';
        ...
        // we can't specify one here like we do for XML or OBJ. This means
